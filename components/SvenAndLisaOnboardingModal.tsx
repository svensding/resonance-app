    ...
    >
      ...
      >
        <div className="flex justify-between items-center mb-[1.5vh] sm:mb-[2vh]">
          <h2 id="sven-lisa-onboarding-title" className="text-[clamp(1.1rem,3vh,1.75rem)] font-semibold text-sky-400 font-playfair">{title}</h2>
          <button 
            onClick={onClose} 
        ...
        <div className="space-y-[1vh] sm:space-y-[1.5vh] text-slate-300 max-h-[60vh] sm:max-h-[70vh] overflow-y-auto scrollbar-thin pr-[0.5vw] sm:pr-[1vw]">
          <p className="text-[clamp(0.75rem,2.2vh,1rem)] whitespace-pre-wrap">{message}</p>
        </div>
        ...
        <div className="mt-[2vh] sm:mt-[3vh] flex justify-end">
          <button
            ...
            className="px-[2.5vw] py-[1.2vh] sm:px-[3vw] sm:py-[1.5vh] text-[clamp(0.8rem,2.3vh,1.1rem)] font-medium text-white bg-sky-600 hover:bg-sky-500 rounded-md transition-colors focus:outline-none focus:ring-2 focus:ring-sky-400 focus:ring-offset-2 focus:ring-offset-slate-800"
