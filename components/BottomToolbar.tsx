...
export const BottomToolbar: React.FC<BottomToolbarProps> = ({ 
  ...
  return (
    <div className="px-[1vw] py-[1vh] sm:py-[1.2vh] flex items-center justify-between space-x-[1vw] md:space-x-[1.5vw] w-full overflow-hidden font-normal">
        <div className="flex items-center space-x-[1vw] md:space-x-[1.5vw] overflow-x-auto scrollbar-thin flex-1">
            <button
            ...
            <div className="flex items-center space-x-[0.5vw] sm:space-x-[1vw] flex-nowrap">
                ...
                <div key={participant.id} className="flex-shrink-0 flex items-center space-x-[0.3vw] sm:space-x-[0.5vw]">
                    ...
                    <input
                        ...
                        className={`px-[1.2vw] py-[0.6vh] sm:px-[1.5vw] sm:py-[0.8vh] text-[clamp(0.58rem,1.7vh,0.88rem)] rounded-md shadow-sm text-white w-[18vw] xs:w-[20vw] sm:w-[15vw] md:w-[12vw] max-w-[120px] font-normal transition-colors duration-200
                    ...
                    <button
                        ...
                        disabled={disabled}
                        className={`px-[1.2vw] py-[0.6vh] sm:px-[1.5vw] sm:py-[0.8vh] text-[clamp(0.58rem,1.7vh,0.88rem)] rounded-md transition-colors duration-150 truncate w-[18vw] xs:w-[20vw] sm:w-[15vw] md:w-[12vw] max-w-[120px] 
            ...
            {!isSoloMode && (
              <button
                  ...
                  className={`p-[1vh] sm:p-[1.2vh] rounded-full text-white transition-colors duration-150 flex-shrink-0
